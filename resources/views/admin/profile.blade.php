                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                       <a class="float-left">{{App\User::all()->count()}}</a> <b class="float-right">  الاعضاء</b>
                                    </li>
                                    <li class="list-group-item">
                                        <b class="float-right">الرسائل</b> <a class="float-left">{{App\contact::all()->count()}}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b class="float-right">العقارات</b> <a class="float-left">{{App\Bu::all()->count()}}</a>
                                    </li>
                                </ul>
